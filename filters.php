...
<body>
        ...
        <div class="header">
            ...
            <table class="nav">
                 <tr>
                   ...
                   <th style="padding: 1; float: left; padding-top: 1.3rem;" class="nav1"><a href="">Home</a></th>
                   <th style="padding: 15; float: left; padding-left: 1.2rem; padding-top: 1.3rem;" class="nav1"><a href="">About us</a></th>
                   <th style="padding: 15; float: left; padding-left: 1.2rem; padding-top: 1.3rem;" class="nav1"><a href="">Contact us</a></th>
                   <th style="padding: 15; float: left; padding-left: 1.2rem; padding-top: 1.3rem;" class="nav1"><a href="">Policy</a></th>
	...
	<?php 
		...
		$price2 = $_SESSION['p2'];
		$bhk = $_SESSION['r1'];
        $furnished = $_SESSION['r2'];

                // Connection to Database
                $conn = new mysqli('localhost','root','','clg_project');
                
                $query = "SELECT * FROM listing_1_table t1 INNER JOIN listing_2_table t2 ON t1.L_email=t2.L_email WHERE Property_type='$property' && Approve='1' && Rent BETWEEN $price1 AND $price2 && Bedrooms='$bhk' && Furnished='$furnished'";
